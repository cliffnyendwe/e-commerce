# Generated by Django 2.2 on 2020-08-05 06:48
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('apartment_address', models.CharField(default='street1', max_length=100)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('item_status', models.CharField(choices=[('Available', 'Available'), ('Not available', 'Not available'), ('Reserved', 'Reserved')], max_length=50)),
                ('price', models.FloatField()),
                ('discount_price', models.FloatField(blank=True, null=True)),
                ('category', models.CharField(choices=[('M', 'Men'), ('L', 'Ladies'), ('C', 'Children')], max_length=2)),
                ('label', models.CharField(choices=[('P', 'primary'), ('S', 'secondary'), ('D', 'danger'), ('W', 'warning')], max_length=1)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ordered', models.BooleanField(default=False)),
                ('quantity', models.IntegerField(default=1)),
                ('item', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='ecommerce.Bags')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.AddField(
            model_name='order',
            name='items',
            field=models.ManyToManyField(to='ecommerce.OrderBags'),
        ),
        migrations.AddField(
            model_name='order',
            name='payment',
        ...
        migrations.AddField(
            model_name='item',
            name='location',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='ecommerce.Location'),
        ),
        migrations.AddField(
            model_name='bags',
            name='Category',
